...
# Network management script for talos-control-plane-4 (ibm provider)
set -euo pipefail

NODE_NAME="talos-control-plane-4"
PROVIDER="ibm"
HOST_IP="10.3.1.1"
NS_IP="10.3.1.2"
...
show_network_info() {
    ...
    echo "  Node IP: $NS_IP"
    echo "  Network: 10.3.0.0/16"
    echo "  Gateway: 10.3.1.1"
    echo "  Bridge: bridge-ibm"
}

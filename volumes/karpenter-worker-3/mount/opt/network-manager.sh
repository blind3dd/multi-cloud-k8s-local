...
# Network management script for karpenter-worker-3 (gcp provider)
set -euo pipefail

NODE_NAME="karpenter-worker-3"
PROVIDER="gcp"
HOST_IP="10.2.1.1"
NS_IP="10.2.3.2"
...
show_network_info() {
    ...
    echo "  Node IP: $NS_IP"
    echo "  Network: 10.2.0.0/16"
    echo "  Gateway: 10.2.1.1"
    echo "  Bridge: bridge-gcp"
}

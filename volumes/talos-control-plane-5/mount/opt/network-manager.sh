...
# Network management script for talos-control-plane-5 (digitalocean provider)
set -euo pipefail

NODE_NAME="talos-control-plane-5"
...
show_network_info() {
    ...
    echo "  Node IP: $NS_IP"
    echo "  Network: 10.4.0.0/16"
    echo "  Gateway: 10.4.1.1"
    echo "  Bridge: bridge-do"
}
